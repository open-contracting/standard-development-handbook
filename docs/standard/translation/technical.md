...
* [Create a Transifex project](https://www.transifex.com/open-contracting-partnership-1/), named e.g. `open-contracting-standard-1-1`
...
1. Update the `language_options` block in `docs/_templates/layout.html`
