...
[Merge the development branch](#merge-the-development-branch) will trigger a build on Travis. For changes to the theme, hit rebuild on the previous build for the relevant live branch.
