...
-  If no ``id`` field is specified, the array is merged as a whole. To make the merging behavior explicit, you should set ``"wholeListMerge": true``. This is appropriate if:
